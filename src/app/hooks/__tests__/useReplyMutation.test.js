...
describe("useReplyMutation", () => {
    ...
    it("Deve chamar o mutate e tratar o sucesso", async () => {
        global.fetch.mockResolvedValueOnce({
            ok: true,
            json: () => Promise.resolve({ message: "Reply created successfully" }),
        });
        ...
        expect(fetch).toHaveBeenCalledWith('http://localhost:3000/api/comment/1/replies', {
            method: "POST",
            headers: {
